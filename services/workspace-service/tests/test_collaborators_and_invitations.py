...
async def test_invite_member_success():
    ...
    ws = Workspace(id=ws_id, owner_id=owner_id, name="Test WS", description="", visibility="PRIVATE", status="ACTIVE", cover_image_url=None, created_at=datetime.now(timezone.utc), updated_at=datetime.now(timezone.utc))
