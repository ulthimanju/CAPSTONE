 ...
 *
 * Directly displays the raw received learning path JSON payload.
 */
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: '12px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>
              {learningData ? `${JSON.stringify(learningData).length} bytes` : '0 bytes'}
            </span>
          </div>
