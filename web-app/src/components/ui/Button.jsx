...
const variantStyles = {
  primary: 'bg-accent bg-gradient-to-br from-[#E08850] to-[#C1622D] text-on-accent hover:from-[#E89860] hover:to-[#C96C35] active:scale-[0.99] shadow-theme focus-visible:ring-accent',
  secondary: 'bg-gradient-to-br from-[#A3B598] to-[#7A8B6F] text-white hover:from-[#B0C1A6] hover:to-[#87997C] active:scale-[0.99] shadow-xs focus-visible:ring-sage',
